...
Notice that the standard errors are computed using a "HAC" estimator of the variance-covariance matrix, see Chapter \@ref(apatadlm) (reference to 15.4 instead of 14.5) for a discussion of this estimator.
